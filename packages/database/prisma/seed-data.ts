// Static reference data used by the seed script. Kept separate from the
// orchestration logic in seed.ts so each file stays readable.
...
export const STATUSES = [
  { name: "New", order: 0, isClosed: false, isDefault: true },
  { name: "Open", order: 1, isClosed: false, isDefault: false },
  { name: "In Progress", order: 2, isClosed: false, isDefault: false },
  { name: "Pending", order: 3, isClosed: false, isDefault: false },
  { name: "Resolved", order: 4, isClosed: false, isDefault: false },
  { name: "Closed", order: 5, isClosed: true, isDefault: false },
  { name: "Reopened", order: 6, isClosed: false, isDefault: false },
];
